...
db.planets.insertMany([
  {
    ...
    summary: 'The Sun is a hot ball of glowing gases at the heart of our solar system. Its gravity holds the solar system together, in its orbit everything from the biggest planets to the smallest particles of debris. There are billions of stars like our Sun scattered across the Milky Way galaxy. The Sun drives the Earths seasons, ocean currents, weather, climate, radiation belts and auroras.'
    sizeAndDistance: 'With a radius of 432,168.6 miles (695,508 kilometers), the Sun is still far larger than our home planet: 332,946 Earths. The Sun’s volume would need 1.3 million Earths to fill it. The Sun is 93 million miles (150,000 kilometers) from Earth.'
    orbitAndRotation: 'The Sun, and everything that orbits it, is located in the Milky Way galaxy. The Sun orbits the center of the Milky Way Galaxy, bringing the planets, asteroids, comets and other objects along with it. Our Sun is in a spiral arm called the Orion Spur that extends outward from the Sagittarius arm. Our solar system is moving with an average velocity of 450,000 miles per hour (720,000 kilometers per hour). But even at this speed, it takes us about 230 million years to make one complete orbit around the Milky Way. At the equator, the Sun spins around once about every 25 days, but at its poles the Sun rotates once on its axis every 36 Earth days.',
    formation: 'The Sun and the rest of the solar system formed from a solar nebula about 4.5 billion years ago. The Sun will someday run out of energy. When the Sun starts to die, it will swell so big that it will engulf Mercury and Venus and maybe even Earth. However the Sun is a little less than halfway through its lifetime and will last another 6.5 billion years before it shrinks down to be a white dwarf.',
