...
db.planets.insertMany([
  {
    ...
    summary: 'The Sun is a hot ball of glowing gases at the heart of our solar system. Its gravity holds in its orbit everything from the biggest planets to the smallest particles of debris. There are billions of stars like our Sun scattered across the Milky Way galaxy.  The Sun’s volume would need 1.3 million Earths to fill it.',
    orbitAndRotation: 'Located in the Milky Way Galaxy, the Sun orbits the center of the Galaxy, bringing the planets, asteroids, comets and other objects along with it. Our Sun is in a spiral arm called the Orion Spur that extends outward from the Sagittarius arm. Our solar system is moving with an average velocity of 450,000 miles per hour (720,000 kilometers per hour). But even at this speed, it takes us about 230 million years to make one complete orbit around the Milky Way. At the equator, the Sun spins around once about every 25 days, but at its poles the Sun rotates once on its axis every 36 Earth days.At the equator, the Sun spins once about every 25 days, but at its poles the Sun rotates once on its axis every 35 Earth days.',
    formation: "The Sun and the rest of the solar system formed from a solar nebula about 4.5 billion years ago. The Sun will someday run out of energy. When the Sun starts to die, it will swell so big that it will engulf Mercury and Venus and maybe even Earth. However the Sun is a little less than halfway through its lifetime and will last another 6.5 billion years before it shrinks down to be a white dwarf. Its core is about 27 million degrees Fahrenheit (15 million degrees Celsius).",
    life: 'With its hot, energetic mix of gases and plasma life does not exist in the Sun. But the Sun has made life on Earth possible, providing warmth as well as energy that organisms like plants use to form the basis of many food chains. The Sun drives the Earths seasons, ocean currents, weather, climate, radiation belts and auroras.'
  },
  {
    name: 'Mercury',
    ...
    formation: "Mercury is a rocky planet, also known as a terrestrial planet. It has a central core, a rocky mantle and a solid cratered surface, much like the Earth's moon.",
  ...
  },
  {
    ...
    formation: "Venus' solid surface is a volcanic landscape covered with extensive plains featuring high volcanic mountains and vast ridged plateaus. It has a central core, a rocky mantle and a solid crust.",
...

  {
    ...
    summary: "Mars is the fourth planet from the Sun. It is a dusty, cold, desert world with a very thin atmosphere. This dynamic planet has seasons, polar ice caps, extinct volcanoes, canyons and weather. Mars is one of the most explored bodies in our solar system, and it's the only planet where we've sent rovers to roam the alien landscape. NASA missions have found lots of evidence that Mars was much wetter and warmer, with a thicker atmosphere, billions of years ago. Today it is frequently called the Red Planet because iron minerals in the Martian dirt oxidize, or rust, causing the surface to look red. It also has two moons named Phobos and Deimos. Mars is about half the size of Earth. It takes sunlight 13 minutes to travel from the Sun to Mars.",
    ...
    formation: "Mars is a rocky planet. Its solid surface has been altered by volcanoes, impacts, winds, crustal movement and chemical reactions. Mars is about half the size of Earth, and like its fellow terrestrial planets, it has a central core, a rocky mantle and a solid crust.",
...

  {
    ...
    formation: "Saturn is mostly made of hydrogen and helium, the same two main components that make up the Sun.",
...

  {
    ...
    summary: "The seventh planet from the Sun with the third largest diameter in our solar system, Uranus is very cold and windy. The ice giant is surrounded by 13 faint rings and 27 small moons. The inner rings are narrow and dark and the outer rings are brightly colored. The moons are named after characters from the works of William Shakespeare and Alexander Pope. Uranus rotates at a nearly 90-degree angle from the plane of its orbit. This unique tilt makes the planet appear to spin on its side, orbiting the Sun like a rolling ball. The first planet found with the aid of a telescope, Uranus was discovered in 1781 by astronomer William Herschel. Uranus is 4 times wider than Earth. It takes sunlight 2 hours and 40 minutes to travel from the Sun to Uranus.",
    ...
    formation: "Uranus likely formed closer to the Sun and moved to the outer solar system about 4 billion years ago. It is an ice giant. Most of its mass is a hot, dense fluid of 'icy' materials – water, methane and ammonia – above a small rocky core.",
...

  {
    ...
    life: "The surface of Pluto is extremely cold, so it seems unlikely that life could exist there. At such cold temperatures, water, which is vital for life as we know it, is essentially rock-like. Pluto's interior is warmer, however, and some think there could be an ocean deep inside."
  },

  {
    ...
    summary: "In January 2015, Caltech astronomers Konstantin Batygin and Mike Brown announced new research that provides evidence of a giant planet tracing an unusual, elongated orbit in the outer solar system. The prediction is based on detailed mathematical modeling and computer simulations, not direct observation. This large object could explain the unique orbits of at least five smaller objects discovered in the distant Kuiper Belt. The Caltech scientists believe Planet X may have has a mass about 10 times that of Earth and be similar in size to Uranus or Neptune. The possibility of a new planet is certainly exciting but it's too early to say with certainty that there is a so-called Planet X. ",

    orbitAndRotation: "his hypothetical Neptune-sized planet orbits our sun in a highly elongated orbit far beyond Pluto. The predicted orbit is about 20 times farther from our sun on average than Neptune (which orbits the sun at an average distance of 2.8 billion miles). It would take this new planet between 10,000 and 20,000 years to make just one full orbit around the sun.",
